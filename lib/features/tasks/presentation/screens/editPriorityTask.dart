...
class Editprioritytask extends ConsumerStatefulWidget {
  final Prioritytask prioritytask;
  const Editprioritytask({super.key, required this.prioritytask});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _EditprioritytaskState();
}
...
late Map<String, Minitask> miniTasks;
late DateTime startDate;
late DateTime endDate;

class _EditprioritytaskState extends ConsumerState<Editprioritytask> {
  @override
  void initState() {
    super.initState();
    titleController = TextEditingController(text: widget.prioritytask.title);
    descriptionController =
        TextEditingController(text: widget.prioritytask.description);
    miniTasks = widget.prioritytask.miniTasksList;
    startDate = widget.prioritytask.startDate;
    endDate = widget.prioritytask.endDate;
  }
                                ...
                                final dz.Either<Failure, void> res =
                                    await Createnewpriorusecase(
                                        ...
                                        .call(Prioritytask(
                                            ...
                                            startDate: startDate,
                                            endDate: endDate,
                                            id: widget.prioritytask.id,
                                            status: widget.prioritytask.status,
                                            miniTasksList: miniTasks,
                                            color: widget.prioritytask.color));
...
class Editprioritytasksucces extends StatefulWidget {
  const Editprioritytasksucces({
    super.key,
  });

  @override
  State<Editprioritytasksucces> createState() => _EditprioritytasksuccesState();
}

class _EditprioritytasksuccesState extends State<Editprioritytasksucces>
